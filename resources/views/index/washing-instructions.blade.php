        ...
        <main id="MainContent" class="content-for-layout">
            <div class="contact-page">
                <div class="latest-blog-section mt-100 overflow-hidden home-section">
                    ...
                    <div class="latest-blog-inner mt-5 mb-5">
                        <div class="container">
                            <div class="section-header text-center">
                                 @if (isset($image) && $image->image_path)
                                    <img src="{{ asset('storage/' . $image->image_path) }}" alt="Washing Instructions"
                                        >
                                @else
                                <img src="{{ asset('index') }}/assets/img/washing-instructions.jpg" alt="">
                                @endif
                            </div>
                        </div>
                    </div>
